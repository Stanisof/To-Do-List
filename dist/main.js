...
function addProject(title) {
    ...
    renderProject(mainArray); // zeigt die Projekte in der sidebar an
    addNote(newProject); //ist der Listener für Submit form
    removePreviousContent(); // entfernt erst die Notizen von anderem Projekt
    renderNote(newProject); // zeigt die Notizen im content Bereich an
